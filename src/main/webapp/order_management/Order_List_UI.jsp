...
<%@ page import="order_control.Order_Search" %>

<%
String status = request.getParameter("status");

Order_Search control = new Order_Search();
List<Order> list;
...
if(status.equals("전체")){
	...
	list = control.getProcessingList();
}
else{
	list = control.getCompleteList();
}
...
<div class="row">
	<div class="col-6" style="margin-right: 0px;">
		<div class="card" style="margin-right: 0px;">
			<div class="card-header"
				style="font-size: 20px; background-color: white;">수주 목록</div>
			<div class="card-body">
				<table id="mytable" class="table table-bordered" style="width: 100%;"
					...
					<tbody style="border-top: none;">
						...
						<tr class="trs pagegroup<%=pagegroup%>" id="<%=o.getOrder_number() %>" onclick="TableClickEvent(this)">
							<td style="display:none"><%=o.getOrder_number() %></td>
							<td><%=o.getOrder_name() %></td>
							<td><%=o.getExp_date() %></td>
						</tr>
				...
				function TableClickEvent(element){
					...
					$.ajax({
						type:"GET",
				        url:"./Order_Content_UI.jsp",
				        data:{selectedTable : selectedTable},
				        dataType:"html",
				        success:function(data){
				            $("#Order_Content_UI").html(data);
				      }
				   });
				}
	...
	<div class="col-6" id="Order_Content_UI" style="margin-left:0px;">
