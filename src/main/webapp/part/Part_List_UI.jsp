...
<%@ page import="part_control.Part_Search" %>


<%
String part_name = request.getParameter("part_name");

Part_Search control = new Part_Search();
List<Part> list;
...
if(part_name == null || part_name.equals("")){
	...
	list = control.getSearchedList(part_name);
}
...
<div class="row">
		...
		<div class="card" style="margin-right: 0px;">
			...
			<div class="card-body">
				...
				function TableClickEvent(element){
					...
					$.ajax({
						type:"GET",
				        url:"./Part_Content_UI.jsp",
				        data:{selectedTable : selectedTable},
				        dataType:"html",
				        success:function(data){
				            $("#Part_Content_UI").html(data);
				      }
				   });
				}
	...
	<div class="col-6" id="Part_Content_UI" style="margin-left:0px;">
