...
<%@ page import="facility_control.Facility_Search" %>

<%

Facility_Search control = new Facility_Search();
List<Facility> list;
...
<div class="row">
	<div class="col-6" style="margin-right: 0px;">
		<div class="card" style="margin-right: 0px;">
			<div class="card-header"
				style="font-size: 20px; background-color: white;">설비 목록</div>
			<div class="card-body">
				<table id="mytable" class="table table-bordered" style="width: 100%;"
					...
					<tbody style="border-top: none;">
						...
						<tr class="trs pagegroup<%=pagegroup%>" id="<%=f.getFacility_name() %>" onclick="TableClickEvent(this)">
							<td><%=f.getFacility_name() %></td>
							<td><%=f.getStatus() %></td>
						</tr>
				...
				function TableClickEvent(element){
					...
					$.ajax({
						type:"GET",
				        url:"./Facility_Content_UI.jsp",
				        data:{selectedTable : selectedTable},
				        dataType:"html",
				        success:function(data){
				            $("#Facility_Content_UI").html(data);
				      }
				   });
				}
	...
	<div class="col-6" id="Facility_Content_UI" style="margin-left:0px;">
