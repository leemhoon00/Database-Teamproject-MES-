...
<%@ page import="company_control.Company_Search" %>

<%
String company_name = request.getParameter("company_name");

Company_Search control = new Company_Search();
List<Company> list;
...
if(company_name == null || company_name.equals("")){
	...
	list = control.getSearchedList(company_name);
}
...
<div class="row">
	<div class="col-6" style="margin-right: 0px;">
		<div class="card" style="margin-right: 0px;">
			<div class="card-header"
				style="font-size: 20px; background-color: white;">기업 목록</div>
			<div class="card-body">
				<table id="mytable" class="table table-bordered" style="width: 100%;"
					...
					<tbody style="border-top: none;">
						...
						<tr class="trs pagegroup<%=pagegroup%>" id="<%=c.getCompany_name() %>" onclick="TableClickEvent(this)">
				...
				function TableClickEvent(element){
					...
					$.ajax({
						type:"GET",
				        url:"./Company_Content_UI.jsp",
				        data:{selectedTable : selectedTable},
				        dataType:"html",
				        success:function(data){
				            $("#Company_Content_UI").html(data);
				      }
				   });
				}
	...
	<div class="col-6" id="Company_Content_UI" style="margin-left:0px;">
